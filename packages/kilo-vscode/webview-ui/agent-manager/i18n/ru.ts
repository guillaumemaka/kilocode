export const dict = {
  ...
  "agentManager.project.clone": "Клонировать репозиторий...",
  "agentManager.project.cloneTitle": "Клонировать репозиторий",
  "agentManager.project.urlLabel": "URL репозитория",
  "agentManager.project.urlPlaceholder": "https://example.com/org/repo.git или git@example.com:org/repo.git",
  "agentManager.project.alreadyAdded": "Этот репозиторий уже добавлен. Откроется существующий проект.",
  "agentManager.project.newTitle": "Новый проект",
  "agentManager.project.nameLabel": "Название проекта",
  "agentManager.project.namePlaceholder": "мой-проект",
  "agentManager.project.parentLabel": "Родительская папка",
  "agentManager.project.browse": "Выбрать папку...",
  "agentManager.project.destination": "Расположение",
  "agentManager.project.create": "Создать проект",
  ...
  "agentManager.tab.closeToRight": "Закрыть справа",
  ...
  "agentManager.browser.missingChrome":
    "Google Chrome не найден. Установите Chrome для использования встроенного браузера, затем повторите попытку.",
  ...
  "agentManager.browser.noSession": "Запустите или выберите сеанс в Agent Manager.",
