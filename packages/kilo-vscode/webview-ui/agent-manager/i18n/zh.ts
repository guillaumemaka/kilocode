export const dict = {
  ...
  "agentManager.project.new": "新建项目...",
  "agentManager.project.openLocal": "打开本地文件夹...",
  ...
  "agentManager.project.parentLabel": "父文件夹",
  "agentManager.project.browse": "选择文件夹...",
  "agentManager.project.destination": "位置",
  "agentManager.project.create": "创建项目",
  ...
  "agentManager.browser.empty": "打开本地应用或公开的 HTTPS 页面，即可在此处预览。",
  "agentManager.browser.requirement": "需要 Google Chrome 或兼容的 Playwright Chromium 浏览器。浏览器不会自动安装。",
  "agentManager.browser.missingTitle": "未找到浏览器",
  "agentManager.browser.missingChrome": "未找到 Google Chrome。请安装 Chrome 以使用集成浏览器，然后重试。",
  "agentManager.browser.missingChromium":
    "未找到 Playwright Chromium。请安装兼容的浏览器，或在“浏览器设置”中启用“使用系统 Chrome”。",
  "agentManager.browser.downloadChrome": "下载 Chrome",
  "agentManager.browser.settings": "浏览器设置",
  "agentManager.browser.noSession": "请在 Agent Manager 中启动或选择会话。",
