export const dict = {
  ...
  "agentManager.project.new": "새 프로젝트...",
  "agentManager.project.openLocal": "로컬 폴더 열기...",
  ...
  "agentManager.project.parentLabel": "상위 폴더",
  "agentManager.project.browse": "폴더 선택...",
  "agentManager.project.destination": "위치",
  "agentManager.project.create": "프로젝트 만들기",
  ...
  "agentManager.browser.empty": "로컬 애플리케이션이나 공개 HTTPS 페이지를 열어 여기에서 미리 보세요.",
  "agentManager.browser.requirement":
    "Google Chrome 또는 호환되는 Playwright Chromium 브라우저가 필요합니다. 브라우저는 자동으로 설치되지 않습니다.",
  "agentManager.browser.missingTitle": "브라우저를 찾을 수 없음",
  "agentManager.browser.missingChrome":
    "Google Chrome을 찾을 수 없습니다. 통합 브라우저를 사용하려면 Chrome을 설치한 후 다시 시도하세요.",
  "agentManager.browser.missingChromium":
    "Playwright Chromium을 찾을 수 없습니다. 호환되는 브라우저를 설치하거나 ‘브라우저 설정’에서 ‘시스템 Chrome 사용’을 활성화하세요.",
  "agentManager.browser.downloadChrome": "Chrome 다운로드",
  "agentManager.browser.settings": "브라우저 설정",
  "agentManager.browser.noSession": "Agent Manager에서 세션을 시작하거나 선택하세요.",
