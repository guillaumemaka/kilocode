export const dict = {
  ...
  "agentManager.project.clone": "Клонувати репозиторій...",
  "agentManager.project.cloneTitle": "Клонувати репозиторій",
  "agentManager.project.urlLabel": "URL репозиторію",
  "agentManager.project.urlPlaceholder": "https://example.com/org/repo.git або git@example.com:org/repo.git",
  "agentManager.project.alreadyAdded": "Цей репозиторій уже додано. Відкриється наявний проєкт.",
  "agentManager.project.newTitle": "Новий проєкт",
  "agentManager.project.nameLabel": "Назва проєкту",
  "agentManager.project.namePlaceholder": "мій-проєкт",
  "agentManager.project.parentLabel": "Батьківська папка",
  "agentManager.project.browse": "Вибрати папку...",
  "agentManager.project.destination": "Розташування",
  "agentManager.project.create": "Створити проєкт",
  ...
  "agentManager.browser.missingChrome":
    "Google Chrome не знайдено. Встановіть Chrome для використання вбудованого браузера, а потім повторіть спробу.",
  ...
  "agentManager.browser.noSession": "Запустіть або виберіть сесію в Agent Manager.",
