export const dict = {
  ...
  "agentManager.browser.empty": "ローカルアプリケーションまたは公開 HTTPS ページを開くと、ここでプレビューできます。",
  "agentManager.browser.requirement":
    "Google Chrome または互換性のある Playwright Chromium ブラウザーが必要です。ブラウザーは自動でインストールされません。",
  "agentManager.browser.missingTitle": "ブラウザーが見つかりません",
  "agentManager.browser.missingChrome":
    "Google Chrome が見つかりません。統合ブラウザーを使用するには、Chrome をインストールしてから再試行してください。",
  "agentManager.browser.missingChromium":
    "Playwright Chromium が見つかりません。互換性のあるブラウザーをインストールするか、「ブラウザー設定」で「システムChromeを使用」を有効にしてください。",
  "agentManager.browser.downloadChrome": "Chrome をダウンロード",
  "agentManager.browser.settings": "ブラウザー設定",
  "agentManager.browser.noSession": "Agent Manager でセッションを開始または選択してください。",
