export const dict = {
  ...
  "agentManager.project.nameLabel": "Projektname",
  "agentManager.project.namePlaceholder": "mein-projekt",
  "agentManager.project.parentLabel": "Übergeordneter Ordner",
  "agentManager.project.browse": "Ordner auswählen...",
  "agentManager.project.destination": "Speicherort",
  "agentManager.project.create": "Projekt erstellen",
  ...
  "agentManager.setup.error.worktree_missing":
    "Der Ordner dieses Worktrees existiert nicht mehr. Stelle ihn aus seinem Branch wieder her oder entferne den Worktree.",
  "agentManager.setup.error.worktree_unregistered":
    "Git verfolgt diesen Ordner nicht mehr als Worktree. Entferne ihn und erstelle einen neuen Worktree.",
  "agentManager.setup.error.git_timeout":
    "Git hat nicht rechtzeitig geantwortet. Prüfe, ob das Repository erreichbar ist, und versuche es erneut.",
  ...
  "agentManager.orphans.resolve": "Beheben…",
  ...
  "agentManager.orphans.checkoutWarning": "enthält einen git-Checkout",
  "agentManager.orphans.footerSelected": "{{count}} ausgewählt · {{size}}",
  "agentManager.orphans.footerCheckouts": "{{count}} enthalten noch einen git-Checkout",
  "agentManager.orphans.reveal": "Im Dateisystem anzeigen",
  "agentManager.orphans.revealMac": "Im Finder anzeigen",
  "agentManager.orphans.revealWindows": "Im Explorer anzeigen",
  "agentManager.orphans.revealLinux": "In Dateien anzeigen",
  "agentManager.orphans.deleteButton": "{{count}} Ordner löschen ({{size}})",
