export const dict = {
  ...
  "agentManager.browser.empty": "開啟本機應用程式或公開的 HTTPS 頁面，即可在此處預覽。",
  "agentManager.browser.requirement": "需要 Google Chrome 或相容的 Playwright Chromium 瀏覽器。瀏覽器不會自動安裝。",
  "agentManager.browser.missingTitle": "找不到瀏覽器",
  "agentManager.browser.missingChrome": "找不到 Google Chrome。請安裝 Chrome 以使用整合瀏覽器，然後再試一次。",
  "agentManager.browser.missingChromium":
    "找不到 Playwright Chromium。請安裝相容的瀏覽器，或在「瀏覽器設定」中啟用「使用系統 Chrome」。",
  "agentManager.browser.downloadChrome": "下載 Chrome",
  "agentManager.browser.settings": "瀏覽器設定",
  "agentManager.browser.noSession": "請在 Agent Manager 中啟動或選取工作階段。",
