export const dict = {
  ...
  "agentManager.browser.requirement":
    "Requires Google Chrome or a compatible Playwright Chromium browser. Browsers are not installed automatically.",
  "agentManager.browser.missingTitle": "Browser not found",
  "agentManager.browser.missingChrome":
    "Google Chrome was not found. Install Chrome to use the Integrated Browser, then retry.",
  "agentManager.browser.missingChromium":
    "Playwright Chromium was not found. Install a compatible browser or enable Use System Chrome in Browser Settings.",
  "agentManager.browser.downloadChrome": "Download Chrome",
  "agentManager.browser.settings": "Browser Settings",
  "agentManager.browser.noSession": "Start or select a session in Agent Manager.",
